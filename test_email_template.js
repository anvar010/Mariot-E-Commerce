...
process.env.PUBLIC_SITE_URL = process.env.PUBLIC_SITE_URL || 'https://mariotstore.com';
process.env.MEDIA_BASE_URL = process.env.MEDIA_BASE_URL || 'https://mariot-backend.onrender.com';
    ...
    items: [
        {
            ...
            image: "https://mariotstore.com/wp-content/uploads/2024/10/charbroiler.png"
        }
    ]
};
...
async function runTest() {
    try {
        ...
        const orderSubject = `Your order #${mockOrder.id} delivered — Mariot Store (${new Date().toLocaleTimeString()})`;
        ...
        const mockCartItems = [
            ...
            },
            {
                ...
                price: 6325.00,
                offer_price: null,
                image: "https://mariotstore.com/wp-content/uploads/2024/10/kitchen-equipment-store.png",
