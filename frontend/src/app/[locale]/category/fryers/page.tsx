...
export const metadata: Metadata = {
    title: 'Commercial Fryers & Deep Fryers | Mariot Store',
...
export default async function FryerPage() {
    const data = await getCategoryData('commercial-fryers');
    ...
    return (
        <main>
            ...
            <Suspense fallback={<div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Loader /></div>}>
                <ShopLayout
                    defaultCategory="commercial-fryers"
                    hideCategoryGrid={true}
                    categoryNameOverride="Fryers"
