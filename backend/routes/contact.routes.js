...
const createTable = async () => {
    try {
        ...
        console.error('Error creating contact_submissions table:', error.message);
    }
};
createTable();

// Send email notification — throws error if it fails
const sendEmailNotification = async ({ name, email, countryCode, phone, subject, message }) => {
    ...
    console.log('Contact email sent successfully to', process.env.SMTP_EMAIL);
};
